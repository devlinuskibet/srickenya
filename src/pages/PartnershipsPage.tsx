...
const categories = [
  {
    cat: "International",
    orgs: [
      { name: "IANSA", desc: "International Action Network on Small Arms" },
      { name: "Control Arms", desc: "Control Arms Coalition" },
    ],
  },
  {
    cat: "Regional",
    orgs: [
      { name: "RECSA", desc: "Regional Centre on Small Arms" },
      { name: "IGAD", desc: "Intergovernmental Authority on Development" },
    ],
  },
  {
    cat: "Government & Institutional",
    orgs: [
      { name: "IPSTC", desc: "International Peace Support Training Centre" },
      { name: "KANSA", desc: "Kenya Action Network on Small Arms" },
    ],
  },
  {
    cat: "Community & Civil Society",
    orgs: [{ name: "Community Partners", desc: "Peace committees and grassroots networks across Kenya" }],
  },
];
      ...
      <section className="section-pad-md" style={{ background: "#fff" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64, maxWidth: 700, margin: "0 auto 64px" }}>
            <p style={{ fontSize: 17, color: "var(--text-mid)", lineHeight: 1.8 }}>
              SRIC's impact is amplified through strategic partnerships with leading international, regional,
              governmental, and civil society organizations. These collaborations enable us to scale evidence and extend
              influence across policy environments.
            </p>
          </div>
            ...
            {partners.map((p) => (
              <div key={p.name} className="partner-logo card-hover" style={{ width: 160 }}>
                <div style={{ textAlign: "center" }}>
                  <div
                    style={{ fontFamily: "'Oswald', sans-serif", fontSize: 15, fontWeight: 600, color: "var(--navy)" }}
                  >
                    {p.name}
                  </div>
          ...
          <div style={{ background: "var(--navy)", padding: "64px 56px", textAlign: "center", marginTop: 40 }}>
            ...
            <h2 className="section-heading-white" style={{ marginBottom: 20 }}>
              Become a Partner
            </h2>
            <p
              style={{
