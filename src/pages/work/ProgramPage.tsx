    ...
    <div>
      ...
      <section className="section-pad-md" style={{ background: "#fff" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div
            style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 64, alignItems: "start", marginBottom: 64 }}
            className="grid-2"
          >
            <div>
          ...
          >
            ...
            <h3
              style={{ fontFamily: "'Playfair Display', serif", fontSize: 24, color: "var(--navy)", marginBottom: 32 }}
            >
              Key Focus Areas
            </h3>
