      ...
      <section className="section-pad-lg" style={{ background: "#fff" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 80 }}>
            ...
            >
              "A peaceful and secure region where evidence-driven policies strengthen institutions and empower
              communities."
            </blockquote>
          ...
          <div style={{ background: "var(--navy)", padding: "56px 64px", borderRadius: 2, marginBottom: 80 }}>
            ...
            >
              To generate credible research, inform policy, and strengthen institutional and community capacity in
              addressing human security challenges through collaboration, innovation, and accountability.
            </p>
          </div>
