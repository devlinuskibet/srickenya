      ...
      <section className="section-pad-md" style={{ background: "#fff" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <p style={{ fontSize: 17, color: "var(--text-mid)", lineHeight: 1.8, maxWidth: 700, margin: "0 auto" }}>
              Our values are not aspirational statements—they are the operational principles that guide every research
              study, policy engagement, and partnership we undertake.
            </p>
          </div>
