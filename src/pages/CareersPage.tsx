...
const benefits = [
  ...
  "Evidence-driven institutional culture",
];
          ...
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 64 }} className="grid-2">
            <div>
              ...
              <p className="section-sub">
                SRIC brings together exceptional researchers, policy analysts, and program specialists committed to
                advancing human security across East Africa. We are currently reviewing applications for the following
                positions.
              </p>
