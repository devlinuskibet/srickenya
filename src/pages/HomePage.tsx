  ...
  return (
    <div className="page-load">
      ...
      >
        ...
        />
        <div style={{ position: "absolute", left: "55%", bottom: 80, fontSize: 120, opacity: 0.04 }}>
          {current.icon}
        </div>
        ...
        >
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              <div style={{ fontSize: 12, fontFamily: "'Oswald', sans-serif", letterSpacing: 2 }}>
                YEARS OF RESEARCH
              </div>
            </div>
          </div>
      ...
      <section
        ref={statsRef}
        className="section-pad-lg home-section delay-3"
            ...
            {publications.map((pub) => (
              <div key={pub.title} className="pub-card card-hover">
                ...
                <div style={{ padding: "20px 20px 24px" }}>
                  ...
                  <p style={{ fontSize: 12, color: "var(--text-mid)", lineHeight: 1.7, marginBottom: 16 }}>
                    {pub.desc}
                  </p>
